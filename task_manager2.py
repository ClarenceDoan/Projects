...
# pssd for password, ussnm for username
def user_information(ussnm, pssd): 
 ...
 # Fuction that allows the user to signup
def signup():
 ...
 # Log-in function that will take the username and ask for the password that is connected to it
def login():
...
def task_update(username):
    ...
    print("Enter tasks still in progress: ")
    task_ongoing = input()
...
if __name__ == '__main__':
    print("WELCOME TO CLARENCE`S TASK MANAGER")
